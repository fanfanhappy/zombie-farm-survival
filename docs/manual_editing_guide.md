...
- `resources/settings/farming_action_settings.tres`：开垦、播种、浇水、收获体力消耗。
...
3. 运行 `tests/resource_database_test.gd` 和 `tests/architecture_phase2_test.gd`。
4. 每个独立改动使用中文提交并推送。GitHub 会自动再次运行两项检查。
