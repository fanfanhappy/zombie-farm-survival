...
func _init() -> void:
	...
	assert(game.get_node("UI/InventoryUI/BackpackPanel/Margin/Content/ItemScroll") is ScrollContainer)
	assert(game.get_node("UI/InventoryUI/BackpackPanel/Margin/Content/FilterBar/Search") is LineEdit)
	assert(game.get_node("UI/InventoryUI/BackpackPanel/Margin/Content/FilterBar/Category") is OptionButton)
